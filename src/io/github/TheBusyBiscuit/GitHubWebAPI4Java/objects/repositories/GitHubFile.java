...
/**
 * Represents a file or a directory that is part of a {@link GitHubRepository} or a
 * {@link io.github.TheBusyBiscuit.GitHubWebAPI4Java.objects.GitHubGist}.
 */
public class GitHubFile extends GitHubObject {
     ...
     *             if the connection to the GitHub API could not be established.
     * @since 1.3.3
     */
